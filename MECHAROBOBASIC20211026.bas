...
자이로OFF:
    ...
    '**********************************************
RX_EXIT:
    'ETX 4800, 99  '99는 동작수행완료의 숫자. MAIN참고
    ERX 4800, A, MAIN
...
횟수_전진종종걸음발만_2:
    ...
    보행COUNT = 보행COUNT + 1
    IF 보행COUNT > 보행횟수 THEN  GOTO 횟수_전진종종걸음발만_2_stop

    ERX 4800,A, 횟수_전진종종걸음발만_4
    IF A <> A_old THEN
횟수_전진종종걸음발만_2_stop:
...
횟수_전진종종걸음발만_5:
    ...
    보행COUNT = 보행COUNT + 1
    IF 보행COUNT > 보행횟수 THEN  GOTO 횟수_전진종종걸음발만_5_stop

    ERX 4800,A, 횟수_전진종종걸음발만_1
    IF A <> A_old THEN
횟수_전진종종걸음발만_5_stop:
...
횟수_전진종종걸음물건_2:
    ...
    보행COUNT = 보행COUNT + 1
    IF 보행COUNT > 보행횟수 THEN  GOTO 횟수_전진종종걸음물건_2_stop

    ERX 4800,A, 횟수_전진종종걸음물건_4
    IF A <> A_old THEN
횟수_전진종종걸음물건_2_stop:
...
횟수_전진종종걸음물건_5:
    ...
    보행COUNT = 보행COUNT + 1
    IF 보행COUNT > 보행횟수 THEN  GOTO 횟수_전진종종걸음물건_5_stop

    ERX 4800,A, 횟수_전진종종걸음물건_1
    IF A <> A_old THEN
횟수_전진종종걸음물건_5_stop:
...
적외선거리센서확인:
    적외선거리값 = AD(적외선AD포트)
    'MUSIC "CC"
    'IF 적외선거리값 > 80 THEN '50 = 적외선거리값 = 25(실험을 해봐야)cm
    'MUSIC "C"
    'DELAY 200
    'ENDIF
...
KEY40:
    ETX 4800,40
    GOSUB 양손앞으로나란히
    PRINT "SOUND 8 8 11 !" '북쪽 북쪽 입니다
    GOSUB 기본자세
    GOTO RX_EXIT
    '***************
KEY41:
    ETX 4800,41
    PRINT "SOUND 9 11 !" '안전지역 입니다
    GOTO RX_EXIT
    '***************
KEY42:
    ETX 4800,42
    PRINT "SOUND 10 11 !" '확진구역 입니다
    GOTO RX_EXIT
    '***************
KEY43:
    ETX 4800,43
